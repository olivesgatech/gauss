...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, is_dropout: bool = False):
...
def ResNet18(num_classes=10, is_dropout: bool = False):
    return ResNet(BasicBlock, [2,2,2,2], num_classes, is_dropout=is_dropout)


def ResNet34(num_classes=10, is_dropout: bool = False):
    return ResNet(BasicBlock, [3,4,6,3], num_classes, is_dropout=is_dropout)


class ResNetn(nn.Module):
    def __init__(self, type=18, num_classes=10, pretrained=False, is_dropout: bool = False):
